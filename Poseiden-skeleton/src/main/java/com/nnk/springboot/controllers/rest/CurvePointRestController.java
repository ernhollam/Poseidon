...
public class CurvePointRestController {
     ...
     */
    @GetMapping("/{id}")
    public CurvePoint getBidByID(@PathVariable Integer id) {
     ...
     * @param curvePoint Bid to create.
     * @return saved curvePoint.
     */
    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    public CurvePoint createBid(@RequestBody CurvePoint curvePoint) {
        return service.saveCurvePoint(curvePoint);
    }

    /**
     * Updates a curvePoint.
     * @param curvePoint Bid to update.
     * @return updated curvePoint.
     */
    @PutMapping
    public CurvePoint updateBid(@RequestBody CurvePoint curvePoint) {
