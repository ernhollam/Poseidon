...
public class RuleNameController {
     ...
     * @param id ID of rule to be updated.
     * @param ruleName updated fields of existing rule
     * @param result Result of validation
    ...
    /**
     * Deletes a rule
     * @param id ID of rule to be deleted
     * @return list of rules page
     */
